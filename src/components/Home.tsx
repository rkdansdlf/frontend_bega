                                    ...
                                    <table className="w-full text-sm text-left">
                                        ...
                                        <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                            {rankings.map((team) => (
                                                <tr
                                                    key={team.teamId}
                                                    className={`group hover:bg-gray-50/80 dark:hover:bg-gray-700/50 transition-colors ${team.rank <= 5 ? 'bg-white dark:bg-gray-800' : 'bg-gray-50/30 dark:bg-gray-800/30'
                                                        }`}
                                                >
                                                    <td className="px-3 sm:px-6 py-4 font-bold text-gray-900 dark:text-white">
                                                        <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center text-xs sm:text-sm ${team.rank <= 3
                                                    ...
                                                    <td className="px-3 sm:px-6 py-4">
                                                        <div className="flex items-center gap-2 sm:gap-3">
                                                            <div className="flex-shrink-0 w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center">
                                                                <TeamLogo team={team.shortName || team.teamName} teamId={team.teamId} size={32} className="w-full h-full object-contain" />
                                                            </div>

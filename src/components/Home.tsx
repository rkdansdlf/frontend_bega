            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
              <div className="flex items-center justify-between">
                ...
                <div className="text-white text-right">
                  <div className="text-sm text-white/80 mb-1">{currentSeason} 시즌</div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div
                    className="min-w-[200px] text-center bg-white rounded-lg py-2 px-4 border-2"
                ...
                {isLoading ? (
                  ...
                  <>
                    <TabsContent value="regular" className="mt-8">
                      {filteredGames.regular.length === 0 ? (
                        <p className="text-center py-8 text-gray-500">
                          해당 날짜에 정규시즌 경기가 없습니다.
                        </p>
                      ) : (
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                          {filteredGames.regular.map((game, index) => (
